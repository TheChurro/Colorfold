...
_rot_start_ = vec4(0.49999997, 0.86602545, -0.00000004371139, 0);
_rot_end_ = rot_interp(vec4(1, 0, -0.00000004371139, 0), vec4(-1, -0.00000008742278, -0.00000004371139, 0), (Color_hsv.z - 0)/(1 - 0));
